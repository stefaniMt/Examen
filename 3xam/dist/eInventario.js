...
let mayorExistencia = exports.inventory[0];
for (let i = 1; i < exports.inventory.length; i++) {
    if (exports.inventory[i].quantity > mayorExistencia.quantity) {
        mayorExistencia = exports.inventory[i];
    }
}
